...
const Features = () => {
   ...
   const featureslist=[

    {
        ...
        img: patternslogo,
        description: "Service mesh patterns enable the business function in simple language.",
    },
    {
        name: "Filters",
        className: "title wasm",
        img: wasmlogo,
        description: "Embedded in the data plane of a service mesh, WebAssembly filters offer fine-grained control over service requests.",
    },
    {
        name: "Programs",
        className: "title ebpf",
        img: ebpflogo,
        description: "Embedded in the data plane of a service mesh, eBPF programs performant, fine-grained control over service requests.",
    },
    {
        name: "Policies",
        className: "title OPA",
        img: opologo,
        description: "Applied across the cloud native infrastructure under managemetn, policies may be applied broadly and specificly.",
    }
   ]
    ...
    <div className="box">
      ...
      <div className="circlecont">
        ...
        <div className="hover-circles">
          <div className="circle"><img src={featureslist.img} alt="feature" /></div>
          <div className="circle"><img src={featureslist.img} alt="feature" /></div>
          <div className="circle"><img src={featureslist.img} alt="feature" /></div>
          <div className="circle"><img src={featureslist.img} alt="feature" /></div>
          <div className="circle"><img src={featureslist.img} alt="feature" /></div>
