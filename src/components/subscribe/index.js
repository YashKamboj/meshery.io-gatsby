        ...
        <form action="https://layer5.us15.list-manage.com/subscribe/post?u=6b50be5aea3dfe1fd4c041d80&id=f7bd70043b" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" onsubmit="document.getElementById(mc-embedded-subscribe-form).submit();">
          <div id="mc_embed_signup_scroll">
            <div className="subscribe-inputbox">
              <input type="text"  placeholder="First Name" name="FNAME" className="NAME" id="mce-FNAME" required />
              <input type="text"  placeholder="Last Name" name="LNAME" className="NAME" id="mce-LNAME" required />
            </div>
            ...
            <div style={{display: 'none'}}>
              <input type="text" name="b_6b50be5aea3dfe1fd4c041d80_6bb65defeb" tabIndex={-1}  />
            </div>
            <button className="subscribe-button"  type="submit" name="subscribe-button" id="mc-embedded-subscribe"> Subscribe</button>
          </div>
        </form>
      </div>
      </div>
