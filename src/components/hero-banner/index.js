...
const Hero = () => {
  return (
    ...
    <div className="container">
      ...
      <h1 style={{margin: '1rem 0rem 3rem 0rem', fontSize:"2.7rem" }}><span style={{fontWeight: '200'}}>The cloud-native </span> <br /> <span style={{fontWeight: '700'}}>management plane</span></h1>
      <p>Deploy, Configure, Operate, Measure, Tune</p>
      <Button secondary className="banner-btn two" title="Get Started" url="/service-mesh-management/meshery" />
      </div>
